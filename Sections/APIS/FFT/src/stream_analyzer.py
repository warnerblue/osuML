...
from Sections.APIS.FFT.src.fft import getFFT
from Sections.APIS.FFT.src.utils import *
...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from Sections.APIS.FFT.src.stream_reader_pyaudio import Stream_Reader
            ...
            from Sections.APIS.FFT.src.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device  = device,
                rate    = rate,
                updates_per_second  = updates_per_second,
        ...
        if self.visualize:
            from Sections.APIS.FFT.src.visualizer import Spectrum_Visualizer
    ...
    def strongest_freq(self):
        return self.visualizer.strongest_freq()
